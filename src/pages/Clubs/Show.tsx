...
export default function Show() {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm("Are you sure you want to delete this club record?")) {
  ...
  const columns = [
    {
      ...
      render: (row: Team) => (
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-blue-100 bg-blue-50/50 dark:border-white/5 dark:bg-white/5">
